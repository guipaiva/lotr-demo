...
class _BattleScreenState extends State<BattleScreen> {
  ...
  // TODO 9: Transforme _encerrar() em async
  // TODO 10: Antes de fazer pop, salve o nível no Firestore:
  //   await fellowship.doc(widget.character.docId).update({'level': level});
  void _encerrar() {
  ...
  Widget _buildStatBar(String label, int value, int max, Color color) {
    return Row(
      ...
      children: [
        ...
        SizedBox(
          width: 60,
          child: Text('$value/$max', style: TextStyle(fontSize: 15)),
        ),
      ],
    );
  }
